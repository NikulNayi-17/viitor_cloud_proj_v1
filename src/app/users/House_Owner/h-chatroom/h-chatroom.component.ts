...
@Component({
  selector: 'app-h-chatroom',
  templateUrl: './h-chatroom.component.html',
  styleUrls: ['./h-chatroom.component.css']
})
export class HChatroomComponent implements OnInit {


  @ViewChild('chatcontent') chat_content: ElementRef | undefined;
  ...
  constructor(private router: Router,
    ...
    public datepipe : DatePipe) {
      ...
      firebase.database().ref('chats/').orderByChild('roomname').equalTo(this.roomname).on('value', resp => {
        ...
        console.log(this.chats + 'OKKKKKKKKK');
